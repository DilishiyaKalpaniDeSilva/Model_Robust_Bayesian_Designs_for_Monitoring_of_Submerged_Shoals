...
B <- as.integer(Sys.getenv("B")) # no of MC for the utility approximation
B1 <- as.integer(Sys.getenv("B1")) # no of MC in Laplace approximation 
...
source("codes/designs/polynomial/without_yre/approximate_utility_pol.R")
